                ...
                <div class="row">
                    <div class="col-sm-12 display_table">
                        ...
                        <div class="header_right_buttons display_table_cell text-right hidden-xs">
                            <a href="./#appointment" class="theme_button color1 two_lines bottommargin_0">Donate Now!</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="intro_section page_mainslider ds">
            <div class="flexslider" data-nav="false">
                <ul class="slides">
                    ...
                    <li>
                        <img src="<?=get_template_directory_uri(); ?>/images/slide01.jpg" alt="">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-12">
                    ...
                    <li>
                        <img src="<?=get_template_directory_uri(); ?>/images/slide02.jpg" alt="">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="slide_description_wrapper">
                    ...
                    <li>
                        <img src="<?=get_template_directory_uri(); ?>/images/slide03.jpg" alt="">
                        <div class="container">
                            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 to_animate" data-animation="fadeInUp">
                        <div class="ls with_padding big-padding bg_teaser rounded">
                            <img src="<?=get_template_directory_uri(); ?>/images/story_bg.jpg" alt="">
                            <div>
                    ...
                    <div class="col-md-4 col-sm-6 to_animate" data-animation="fadeInUp">
                        <div class="ls with_padding big-padding bg_teaser rounded">
                            <img src="<?=get_template_directory_uri(); ?>/images/goals_bg.jpg" alt="">
                            <div>
                                <h3 class="thin text-uppercase">
                                    Our
                                    <br>
                    ...
                    <div class="col-md-4 col-sm-12 to_animate" data-animation="fadeInUp">
                        <div class="ls with_padding big-padding bg_teaser rounded">
                            <img src="<?=get_template_directory_uri(); ?>/images/activists_bg.jpg" alt="">
                            <div>
                                <h3 class="thin text-uppercase">
                                    Our
                                    <br>
                                ...
                                <div class="widget widget_slider widget_featured_posts">
                                    ...
                                    <div class="owl-carousel" data-nav="true" data-loop="true" data-autoplay="true" data-items="1" data-responsive-lg="1" data-responsive-md="1" data-responsive-sm="1" data-responsive-xs="1">
                                        <ul>
                                            <li class="media big-left-media">
                                                <div class="media-left media-middle">
                                                    <img src="<?=get_template_directory_uri(); ?>/images/post-thumbs/01.jpg" alt="">
                                                </div>
                                            ...
                                            <li class="media big-left-media">
                                                <div class="media-left media-middle">
                                                    <img src="<?=get_template_directory_uri(); ?>/images/post-thumbs/02.jpg" alt="">
                                                </div>
                                                <div class="media-body media-middle">
                                                    <h4>
                                                        <a href="blog-single-right.html">
                                            ...
                                            <li class="media big-left-media">
                                                <div class="media-left media-middle">
                                                    <img src="<?=get_template_directory_uri(); ?>/images/post-thumbs/03.jpg" alt="">
                                                </div>
                                                <div class="media-body media-middle">
                                                    <h4>
                                                        <a href="blog-single-right.html">
                                        ...
                                        <ul>
                                            <li class="media big-left-media">
                                                <div class="media-left media-middle">
                                                    <img src="<?=get_template_directory_uri(); ?>/images/post-thumbs/04.jpg" alt="">
                                                </div>
                                                <div class="media-body media-middle">
                                                    <h4>
                                                        <a href="blog-single-right.html">
                                            ...
                                            <li class="media big-left-media">
                                                <div class="media-left media-middle">
                                                    <img src="<?=get_template_directory_uri(); ?>/images/post-thumbs/05.jpg" alt="">
                                                </div>
                                                <div class="media-body media-middle">
                                                    <h4>
                                                        <a href="blog-single-right.html">
                                            ...
                                            <li class="media big-left-media">
                                                <div class="media-left media-middle">
                                                    <img src="<?=get_template_directory_uri(); ?>/images/post-thumbs/06.jpg" alt="">
                                                </div>
                                                <div class="media-body media-middle">
                                                    <h4>
                                                        <a href="blog-single-right.html">
                        ...
                        <div class="owl-carousel" data-responsive-lg="2" data-responsive-md="2" data-responsive-sm="1">
                            <article class="vertical-item content-padding text-center with_border rounded">
                                <div class="item-media top_rounded overflow_hidden">
                                    <img src="<?=get_template_directory_uri(); ?>/images/gallery/01.jpg" alt="">
                            ...
                            <article class="vertical-item content-padding text-center with_border rounded">
                                <div class="item-media top_rounded overflow_hidden">
                                    <img src="<?=get_template_directory_uri(); ?>/images/gallery/02.jpg" alt="">
                                    <div class="media-links">
                                        <a href="blog-single-right.html" class="abs-link"></a>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row isotope_container isotope masonry-layout columns_padding_1">
                    ...
                    <div class="isotope-item col-md-3 col-sm-6">
                        <article class="vertical-item content-absolute rounded overflow_hidden text-center">
                            <div class="item-media rounded overflow_hidden">
                                <img src="<?=get_template_directory_uri(); ?>/images/gallery/03.jpg" alt="">
                                <div class="media-links">
                    ...
                    <div class="isotope-item col-md-3 col-sm-6">
                        <article class="vertical-item content-absolute rounded overflow_hidden text-center">
                            <div class="item-media rounded overflow_hidden">
                                <img src="<?=get_template_directory_uri(); ?>/images/gallery/04.jpg" alt="">
                                <div class="media-links">
                    ...
                    <div class="isotope-item col-md-6 col-sm-12">
                        <article class="vertical-item content-absolute rounded overflow_hidden text-center">
                            <div class="item-media rounded overflow_hidden">
                                <img src="<?=get_template_directory_uri(); ?>/images/gallery/05.jpg" alt="">
                                <div class="media-links">
                    ...
                    <div class="isotope-item col-md-3 col-sm-6">
                        <article class="vertical-item content-absolute rounded overflow_hidden text-center">
                            <div class="item-media rounded overflow_hidden">
                                <img src="<?=get_template_directory_uri(); ?>/images/gallery/06.jpg" alt="">
                                <div class="media-links">
                    ...
                    <div class="isotope-item col-md-3 col-sm-6">
                        <article class="vertical-item content-absolute rounded overflow_hidden text-center">
                            <div class="item-media rounded overflow_hidden">
                                <img src="<?=get_template_directory_uri(); ?>/images/gallery/07.jpg" alt="">
                                <div class="media-links">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="owl-carousel" data-responsive-lg="3" data-responsive-md="2" data-responsive-sm="2">
                            <article class="vertical-item content-padding text-center with_border rounded">
                                <div class="item-media top_rounded overflow_hidden">
                                    <img src="<?=get_template_directory_uri(); ?>/images/gallery/08.jpg" alt="">
                                    <div class="media-links">
                                        <a href="blog-single-right.html" class="abs-link"></a>
                                    </div>
                                </div>
                            ...
                            <article class="vertical-item content-padding text-center with_border rounded">
                                <div class="item-media top_rounded overflow_hidden">
                                    <img src="<?=get_template_directory_uri(); ?>/images/gallery/09.jpg" alt="">
                                    <div class="media-links">
                                        <a href="blog-single-right.html" class="abs-link"></a>
                                    </div>
                                </div>
                            ...
                            <article class="vertical-item content-padding text-center with_border rounded">
                                <div class="item-media top_rounded overflow_hidden">
                                    <img src="<?=get_template_directory_uri(); ?>/images/gallery/10.jpg" alt="">
                                    <div class="media-links">
                                        <a href="blog-single-right.html" class="abs-link"></a>
                                    </div>
                                </div>
                        ...
                        <section class="intro_section ds gradient_bg_color2 transp_image rounded">
                            <div class="flexslider" data-nav="false">
                                <ul class="slides">
                                    ...
                                    <li>
                                        <img src="<?=get_template_directory_uri(); ?>/images/banner_slide01.jpg" alt="" class="rounded">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-sm-12 text-center">
                                                    <div class="slide_description_wrapper">
                                    ...
                                    <li>
                                        <img src="<?=get_template_directory_uri(); ?>/images/banner_slide02.jpg" alt="" class="rounded">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-sm-12 text-center">
                                                    <div class="slide_description_wrapper">
                                    ...
                                    <li>
                                        <img src="<?=get_template_directory_uri(); ?>/images/banner_slide03.jpg" alt="" class="rounded">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-sm-12 text-center">
                                                    <div class="slide_description_wrapper">
                    ...
                    <div class="col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="item-media entry-thumbnail top_rounded overflow_hidden">
                                        <img src="<?=get_template_directory_uri(); ?>/images/gallery/11.jpg" alt="">
                                    </div>
                                </div>
                        ...
                        <article class="post format-small-image with_border side-item side-md content-padding responsive-thumb rounded topmargin_40">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-md-push-6">
                                    <div class="item-media entry-thumbnail top_rounded overflow_hidden">
                                        <img src="<?=get_template_directory_uri(); ?>/images/gallery/12.jpg" alt="">
                                    </div>
                                </div>
                        ...
                        <article class="post format-small-image with_border side-item side-md content-padding responsive-thumb rounded topmargin_40">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="item-media entry-thumbnail top_rounded overflow_hidden">
                                        <img src="<?=get_template_directory_uri(); ?>/images/gallery/13.jpg" alt="">
                                    </div>
                                </div>
