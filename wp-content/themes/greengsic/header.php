...
<head>
    ...
    <link rel="stylesheet" href="<?=get_template_directory_uri(); ?>/css/custom.css?ver=12">
    ...
    <link href="<?=get_template_directory_uri(); ?>/css/full_width_animated_layers_001.css?ver=1" rel="stylesheet" media="all">
